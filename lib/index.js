          ...
          handler: async (request, response) => {
            ...
            try {
              ...
              if (path === "quota") {
                ...
                // A quota refresh must not announce an adapter change. That would
                // reload every model directory and make composer indicators flicker.
                // Do not rewrite model settings during a quota poll. Its watcher
                // would reload every provider's model directory.
